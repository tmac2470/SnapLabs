...
evothings.tisensortag.createGenericInstance = function()
{
	...
	instance.callStatusCallback = function(status)
	{
		...
		//console.log("DEBUG - In Status Handler with function " + instance.statusFun + " and status " + status)
	}
...
[
	...
	'libs/evothings/tisensortag/tisensortag-ble-nerld.js',    // Abstract object for BLE tags
	'libs/evothings/tisensortag/tisensortag-ble-cc2650-nerld.js'  // Specific object for CC2650
])
