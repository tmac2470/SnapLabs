...
;(function()
{
	...
	internal.addMethodsToDeviceObject = function(deviceObject)
	{
		...
		{
			//console.log("DEBUG - in easyble.js device.connect")
		...
		{
			//console.log("DEBUG - Writing Characteristics for " + characteristicUUID + " with value " + value)
	...
	{
		//console.log("DEBUG - in Device internal.connectToDevice with parameters success: " + success )
		//console.log("DEBUG - About to call " + evothings.ble.connect)
		evothings.ble.connect(device.address, function(connectInfo)
		{
			//tcm looking for connection information
			//console.log("\n\n\n Device address is: " + device.address + " with information " + JSON.stringify(connectInfo))
			// Trying extra test not to repeat
			if (connectInfo.state == 2 && internal.connectedDevices[device.address] != device) // connected
			{
	...
	*/
		...
		device, serviceUUID, characteristicUUID, value, success, fail)
	{
		...
		var characteristic = device.__serviceMap[key];
		//console.log("DEBUG - Writing Characteristics for " + JSON.stringify(characteristic) + " with value " + value)
